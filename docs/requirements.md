...
| `Fennath__Certificates__DnsPropagationTimeoutSeconds` | 86400 | Max time to wait for TXT record visibility at public resolvers |
| `Fennath__Certificates__DnsPropagationPollingIntervalSeconds` | 60 | How often to query resolvers during propagation check |
